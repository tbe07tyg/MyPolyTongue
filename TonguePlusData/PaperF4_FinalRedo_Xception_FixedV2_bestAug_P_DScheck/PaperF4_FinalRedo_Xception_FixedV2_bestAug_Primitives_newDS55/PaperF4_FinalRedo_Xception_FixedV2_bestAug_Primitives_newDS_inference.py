...
from TonguePlusData.PaperF4_FinalRedo_Xception_FixedV2_bestAug_P_DScheck.PaperF4_FinalRedo_Xception_FixedV2_bestAug_Primitives_newDS55.PaperF4_FinalRedo_Xception_FixedV2_bestAug_Primitives_newDS_Train import YOLO, \
...
fps_list=[]
input_shape=[256,256]
random_seeds_list = range(len(test_input_paths))
for test_path, mask_path in zip(test_input_paths,test_mask_paths):
    input_img, _, myPolygon, _, annotation_line= my_get_random_data(test_path, mask_path, input_shape, None, None, train_or_test="Test", seeds_for_test=random_seeds_list[imgs])
