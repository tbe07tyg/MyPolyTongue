...
from TonguePlusData.P_OurFinal_CioUDMaskDicePolarDioU.P_OurFinal_CioUDMaskDicePolarDioU_Train import YOLO, \
...
for test_path, mask_path in zip(test_input_paths,test_mask_paths):
    ...
    time1 = time.time_ns()/ (10 ** 9)
    # print(" datetime.now() - start:", datetime.now() - start)
