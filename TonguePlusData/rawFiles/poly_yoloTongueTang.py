...
if __name__ == "__main__":
    ...
    def _main():
        ...
        print("current working dir:", os.getcwd())
        annotation_path = 'myTongueTrain.txt'
        validation_path = 'myTongueVal.txt'

        log_dir = 'E:\\Projects\\poly-yolo\\TongueModelsTang256x256_0.5lr_AngleStep5/'
        if not os.path.exists(log_dir):
            os.makedirs(log_dir)

        classes_path = 'yolo_classesTongue.txt'
        anchors_path = 'yolo_anchorsTongue.txt'
        ...
        os.chdir("E:\\Projects\\poly-yolo\\simulator_dataset\\imgs") # for the simulator image path
