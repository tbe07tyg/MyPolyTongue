...
if __name__ == "__main__":
    ...
    def _main():
        ...
        log_dir = (current_file_dir_path + '/TongueModelsTang256x256Mish13poly_yoloTongueTangCSPbackboneNoLastNeckMidSAE.py_0.5lr_AngleStep{}_TonguePlus/').format(ANGLE_STEP)
