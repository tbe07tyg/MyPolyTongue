...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    base_model = Xception(input_tensor=inputs, weights=None, include_top=False)
...
class YOLO(object):
    ...
    def generate(self):
        ...
        try:
            ...
            self.yolo_model = yolo_body(Input(shape=(self.input_image_shape[0], self.input_image_shape[1], 3)), anchors_per_level, num_classes)
