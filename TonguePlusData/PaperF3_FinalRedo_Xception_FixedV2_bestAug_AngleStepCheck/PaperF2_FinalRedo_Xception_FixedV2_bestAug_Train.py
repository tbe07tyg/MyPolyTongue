...
ANGLE_STEP  = sys.argv[2] #that means Poly-YOLO will detect 360/15=24 vertices per polygon at max
# NUM_ANGLES3  = int(360 // ANGLE_STEP * 3) #72 = (360/15)*3
# print("NUM_ANGLES3:", NUM_ANGLES3)
NUM_ANGLES  = int(360 // float(ANGLE_STEP)) # 24
...
if __name__ == "__main__":
    ...
    def _main():
        project_name = 'AS{}\\PaperF3_FinalRedo_Xception_FixedV2_bestAug_AngleStepCheck_{}'.format(ANGLE_STEP, model_index)
