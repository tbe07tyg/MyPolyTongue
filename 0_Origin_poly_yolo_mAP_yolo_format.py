...
def yolo_to_coco(pred_path: str, gt_path: str, classes_path: str) -> None:
    ...
    with open('TonguePlusData/tmp_coco_pred.json', 'w') as ccp:
        json.dump(coco_pred, ccp)
    with open('TonguePlusData/tmp_coco_gt.json', 'w') as ccg:
...
if __name__ == '__main__':
    ...
    # for lab
    pred = "F:\\TonguePolyYOLOLOGS\\MYAugGenerator\\paperresults\\Exp_base3/predictResult.txt"
    gt = "C:\\myProjects\\MyPolyTongue\\TonguePlusData/myTongueTestLab.txt"
    clss = "C:\\myProjects\\MyPolyTongue\\TonguePlusData/yolo_classesTongue.txt"
    type = "bbox"
    # type = "segm"
