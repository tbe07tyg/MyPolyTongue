...
if __name__ == '__main__':
    ...
    for decode in decode_choice:
        # for angle_step in np.linspace(0.1, 20, 100):
        for angle_step in np.linspace(30, 30 , 1):
            IoU_list =[]
            # my_data =  my_Gnearator(raw_input_paths, raw_binary_paths, batch_size=4, input_shape=[256, 256],train_or_test="Test",decode_method=decode, ANGLE_STEP=angle_step)
